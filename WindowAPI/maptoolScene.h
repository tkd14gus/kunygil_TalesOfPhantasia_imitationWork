...
public:
	...
	void frameBoxRender(int left, int top, int width, int height, float scale);			//사각형에 프레임 씌우기 인자는 사각형	※scale값은 가능하면 정수로
	void frameBoxRender(RECT rc, float scale);											//오버로드-> 렉트넣어서 간편하게		※scale < 1 => 제대로 안그려짐
